...
public class Main{
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ArrayList<String> userSurnames = new ArrayList<>();
        ArrayList<String> dateOfBirth = new ArrayList<>();
        ArrayList<String> userEmails = new ArrayList<>();
        String filePath = "C:\\Users\\nmowa\\IdeaProjects\\UserDatabase\\src\\com\\company\\UserDatabase.txt";
        ...
        while(true){
            ...
            if(menuOption == 1){ 		//Add option
                addUser(userNames, userSurnames, userEmails,
    ...
    */
    ...
    static void addUser(ArrayList<String> name, ArrayList<String> surname,
        ...
        dateOfBirth.add(dob);
        //User user = new User(userName, userSurname, userEmail, dob);
